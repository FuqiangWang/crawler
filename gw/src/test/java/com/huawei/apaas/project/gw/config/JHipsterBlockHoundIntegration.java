...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.huawei.apaas.project.gw.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.huawei.apaas.project.gw.security.DomainUserDetailsService", "createSpringSecurityUser");
