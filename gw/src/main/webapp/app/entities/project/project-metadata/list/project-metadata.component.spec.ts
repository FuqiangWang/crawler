...
describe('ProjectMetadata Management Component', () => {
  let comp: ProjectMetadataComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'project-metadata', component: ProjectMetadataComponent }]),
      ...
      .overrideTemplate(ProjectMetadataComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectMetadata?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to projectMetadataService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProjectMetadataIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProjectMetadataIdentifier).toHaveBeenCalledWith(entity);
